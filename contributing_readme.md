...
One way to improve the annotations is for specialists to manually annotate parts of speech and gloss the text. If you are a specialist or native speaker who would like to support this effort, please get in touch by opening an issue or sending an email to one of the maintainers, or simply download the corpus for the language you want to work on and start annotating. Additional instructions for downloading and annotating individual corpora can be found further below.
